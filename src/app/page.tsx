...
export default function Home() {
    ...
    //         ...prevMessages,
    //         { role: "assistant", content: errorData.error.message },
    //     ]);
    //   } 
    //     else {
    //     const data = await response.json();
    //     // ... your existing success handling logic
    //   }
    //     const data = await response.json();
    //     const { output } = data;
    //     console.log("OpenAI replied...", output.content);
    ...
    const callGetResponse = async () => {
      setIsLoading(true);
      let temp = [...messages]; // Make a copy of messages
      temp.push({ role: "user", content: theInput });
      setMessages(temp);
      setTheInput("");
      console.log("Calling OpenAI...");
      ...
      try {
        ...
        const data = await response.json();
        console.log("OpenAI replied...", data.output);
